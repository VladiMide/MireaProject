...
public class Do_story extends Fragment {
    ...
    public static Do_story newInstance(String param1, String param2) {
        Do_story fragment = new Do_story();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_do_story, container, false);
